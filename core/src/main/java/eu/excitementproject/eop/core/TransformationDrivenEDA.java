...
public class TransformationDrivenEDA<T extends TEDecision>
	...
	public static void main(String args[]) {
		...
		try {
			...
			//File input = new File("/tmp/sic.xml");
			//File input = new File("/tmp/SICK_train_RTE_200.xml");
			//File input = new File("/tmp/SICK_train_RTE_changed.xml");
			
			//File input = new File("/tmp/examples.xml");
			//File input = new File("/hardmnt/norris0/zanoli/TBMLEDA/dataset/SICK_ALL_ID.xml");
			File input = new File("/hardmnt/norris0/zanoli/TBMLEDA/dataset/casi-particolari.xml");
			
			//File input = new File("/hardmnt/norris0/zanoli/TBMLEDA/dataset/SICK_train.xml");
			
			//File input = new File("/tmp/sic.xml"); // this only holds the first 3 of them.. generate 3 XMIs (first 3 of t.xml) 
