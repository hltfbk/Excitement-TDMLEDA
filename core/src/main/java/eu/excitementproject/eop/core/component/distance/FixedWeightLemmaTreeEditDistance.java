 ...
 * 
 */
public class FixedWeightLemmaTreeEditDistance extends FixedWeightTreeEditDistance {
     ...
     */
    public FixedWeightLemmaTreeEditDistance() {
     ...
     * 
	 */
    public FixedWeightLemmaTreeEditDistance(double mMatchWeight, double mDeleteWeight, double mInsertWeight, double mSubstituteWeight, boolean stopWordRemoval, String language, Map<String,String> resources) throws ConfigurationException, ComponentException {
	 ...
	 * 
	 */
    public FixedWeightLemmaTreeEditDistance(CommonConfig config) throws ConfigurationException, ComponentException {
